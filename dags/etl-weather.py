...
#Latitude and Longitude for Lagos, Nigeria
LATITUDE = '6.4541'
LONGITUDE = '3.3947'
...
with DAG(dag_id = 'weather_etl_pipeline',
    ...
    def extract_weather_data():
        ...
        #using HTTP Hook to get connection details from Airflow connection
        ...
        if response.status_code == 200:
            ...
            raise Exception(f"Failes to fetch weather data: {response.status_code}")
